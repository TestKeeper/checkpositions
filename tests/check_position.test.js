...
const tradingPairs = [
  'WIF_USD', 'BTC_USD', 'ETH_USD', 'KAITO_USD', 'TON_USD', 'TRUMP_USD', 'XRP_USD',
  '10000BONK_USD', 'ADA_USD', 'APT_USD', 'ARAVAX_USD', 'BETA_USD', 'BNB_USD',
  'CAKE_USD', 'DOGE_USD', 'BOY_USD', 'DYDX_USD', 'ENA_USD', 'FLOKI_USD', 'JUP_USD',
  'LBR_USD', 'LTC_USD', 'OBDAO_USD', 'ORDI_USD', 'PEPE_USD', 'SOL_USD',
  'SUI_USD', 'TRUMPX_USD', 'UNI_USD', 'WLD_USD', 'XLM_USD', 'ZRO_USD',
  '1000BONK_USD', 'AAVE_USD'
];
